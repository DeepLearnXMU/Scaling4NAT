...
fairseq-train ${databin} \
  ...
  --noise full_mask --share-decoder-input-output-embed \
  --encoder-embed-dim 1024 \
  --decoder-embed-dim 256 \
  --encoder-ffn-embed-dim 4096 \
  --decoder-ffn-embed-dim 1048 \
  --encoder-attention-heads 16 \
  --decoder-attention-heads 4 \
  --encoder-layers 12 \
  --decoder-layers 3 \
  --lr 2e-4 --max-tokens 15000 --update-freq 4 \
  --max-update 300000 \
  ...
  --adam-eps 1e-6 --weight-decay 0.01 --dropout 0.2 \
